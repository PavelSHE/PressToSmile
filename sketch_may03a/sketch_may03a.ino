...
//------- WiFi Settings -------
char ssid[] = "PS2H";       // your network SSID (name)
char password[] = "20150423";  // your network key
...
// ------- Telegram config --------
#define BOT_TOKEN "551025608:AAEiyekDcm7rfPIyBAfevEFnNlhzr2t2SRE"  // your Bot Token (Get from Botfather)
#define CHAT_ID "-221709366" // Chat ID of where you want the message to go (You can use MyIdBot to get the chat ID)
